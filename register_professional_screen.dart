...
class RegisterProfessionalScreen extends StatefulWidget {
  ...
  RegisterProfessionalScreen({required this.userType});
...
class _RegisterProfessionalScreenState
  ...
  bool _obscureConfirmText =
      true; // Añadido para el campo de "Repetir contraseña"
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            SizedBox(height: 20),
            CustomTextField(
              hintText: "Nombre de negocio o profesional",
              obscureText: false,
            ...
            CustomButton(
              ...
              onPressed: () async {
                ...
                User? errorMessage = await authService.registerProfessional(
                  email: email,
                  password: password,
                  firstName: firstName,
                  lastName: lastName,
